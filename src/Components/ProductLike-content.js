...
function ProductLikecontent() {
    return (
        <div className="t g-3 mb-3 my-3"                   style={{display:"grid" , gridTemplateColumns:"repeat(auto-fill , minmax(260px , 1fr)) " ,gap:"30PX" }}
        >
...
export default ProductLikecontent
